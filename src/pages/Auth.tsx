    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-secondary/20 to-accent/20 p-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="flex items-center justify-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-foreground">Plantify</h1>
        </div>
        
        <Card className="shadow-xl border-border/50">
          <CardHeader>
            <CardTitle>Welcome</CardTitle>
            <CardDescription>Sign in or create an account to start caring for your plants</CardDescription>
          </CardHeader>
          <CardContent>
